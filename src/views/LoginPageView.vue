...
<div class="h-full flex flex-col justify-center sm:py-12">
  <div class="divider divider-error font-bold text-xl">Regression To The Mean</div>
      ...
      <div class="bg-base-200 shadow w-full rounded-lg divide-y divide-gray-200">
        <div class="px-5 py-7">
          <form @submit.prevent="submit">
            ...
            <input v-model="username" type="text" class="input input-bordered w-full min-w-xs" />
            <div class="label">
              <span class="label-text">Password</span>
            </div>
            <input v-model="password" type="password" class="input input-bordered w-full min-w-xs" />
